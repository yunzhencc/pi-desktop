import type { CustomProviderEntry, CustomProviderInput, CustomProviderModelInput } from './custom-provider-types.ts';
...
} from './custom-provider-types.ts';

export type { CustomProviderEntry, CustomProviderInput, CustomProviderModelInput } from './custom-provider-types.ts';
export {
  BUILT_IN_PROVIDER_IDS,
  CUSTOM_PROVIDER_ID_PATTERN,
  CUSTOM_PROVIDER_PLACEHOLDER_API_KEY,
...
function toProviderConfig(input: CustomProviderInput): Record<string, unknown> {
  ...
  return {
    ...
    apiKey: trimmedKey || CUSTOM_PROVIDER_PLACEHOLDER_API_KEY,
